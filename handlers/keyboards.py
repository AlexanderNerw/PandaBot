...
mfru_buttons = ["Я парень 🧔🏽‍♂️", "Я девушка 👱🏼‍♀️"]
mfua_buttons = ["Я хлопець 🧔🏽‍♂️", "Я дівчина 👱🏼‍♀️"]
mfBRu.add(*mfru_buttons)
mfBUa.add(*mfua_buttons)
...
setting_button_ru_men.add(InlineKeyboardButton(text='  ✅  Русский  ✅  ||   Українська    ', callback_data='setting_lang_ru'))
...
setting_button_uk_men.add(InlineKeyboardButton(text='   Русский   ||   ✅  Українська  ✅ ', callback_data='setting_lang_ua'))
